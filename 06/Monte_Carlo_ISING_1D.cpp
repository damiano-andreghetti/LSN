...
//Read input informations
  ...
  ReadInput >> nstep;
	ReadInput >> newconf; //if=1 -->start new configuration else load config.final
...
double Boltzmann(int sm, int ip) //valutando spin ip (indice), che ha valore sm
{
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=18;
    ...
    stima_c = beta*beta*((blk_av[ic]/blk_norm)-(blk_av[iu]/blk_norm)*(blk_av[iu]/blk_norm)); //Energy
